...
export function DreamInput({ onSubmit, isLoading }: DreamInputProps) {
  ...
  return (
    <div className="w-full max-w-3xl mx-auto">
      <div className="dream-card rounded-2xl p-6 md:p-8 glow-border">
        ...
        <div className="mt-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <Button
            ...
            size="lg"
            className="bg-gradient-gold hover:opacity-90 text-primary-foreground font-medium px-8 rounded-xl transition-all duration-300 hover:shadow-lg hover:shadow-gold/20 disabled:opacity-50"
          >
            {isLoading ? (
